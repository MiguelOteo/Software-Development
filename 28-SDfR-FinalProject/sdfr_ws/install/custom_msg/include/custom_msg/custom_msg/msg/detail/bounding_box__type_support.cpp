...
{
  new (message_memory) custom_msg::msg::BoundingBox(_init);
}

void BoundingBox_fini_function(void * message_memory)
{
  auto typed_message = static_cast<custom_msg::msg::BoundingBox *>(message_memory);
...
static const ::rosidl_typesupport_introspection_cpp::MessageMember BoundingBox_message_member_array[5] = {
  {
    ...
    offsetof(custom_msg::msg::BoundingBox, center_point_x),  // bytes offset in struct
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg::msg::BoundingBox, center_point_y),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg::msg::BoundingBox, width),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg::msg::BoundingBox, height),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
  ...
  },
  {
    ...
    0,  // array size
    false,  // is upper bound
    offsetof(custom_msg::msg::BoundingBox, ball_found),  // bytes offset in struct
    nullptr,  // default value
    nullptr,  // size() function pointer
    nullptr,  // get_const(index) function pointer
    nullptr,  // get(index) function pointer
...
static const ::rosidl_typesupport_introspection_cpp::MessageMembers BoundingBox_message_members = {
  ...
  5,  // number of fields
  sizeof(custom_msg::msg::BoundingBox),
...
get_message_type_support_handle<custom_msg::msg::BoundingBox>()
{
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_INTROSPECTION_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, custom_msg, msg, BoundingBox)() {
  return &::custom_msg::msg::rosidl_typesupport_introspection_cpp::BoundingBox_message_type_support_handle;
}
