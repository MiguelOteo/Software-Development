...
#include "custom_msg/msg/detail/bounding_box__rosidl_typesupport_fastrtps_c.h"
...
using _BoundingBox__ros_msg_type = custom_msg__msg__BoundingBox;
  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: ball_found
  {
    cdr << (ros_message->ball_found ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: ball_found
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->ball_found = tmp ? true : false;
  }
...
size_t get_serialized_size_custom_msg__msg__BoundingBox(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  ...
  // field.name ball_found
  {
    size_t item_size = sizeof(ros_message->ball_found);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
...
static uint32_t _BoundingBox__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_custom_msg__msg__BoundingBox(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_custom_msg
size_t max_serialized_size_custom_msg__msg__BoundingBox(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg__msg__BoundingBox;
    is_plain =
      (
      offsetof(DataType, ball_found) +
      last_member_size
      ) == ret_val;
  }
...
static size_t _BoundingBox__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_custom_msg__msg__BoundingBox(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, custom_msg, msg, BoundingBox)() {
