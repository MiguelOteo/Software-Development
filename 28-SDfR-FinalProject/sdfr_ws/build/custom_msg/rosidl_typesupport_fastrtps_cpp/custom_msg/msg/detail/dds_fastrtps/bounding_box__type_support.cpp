...
#include "custom_msg/msg/detail/bounding_box__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const custom_msg::msg::BoundingBox & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  custom_msg::msg::BoundingBox & ros_message)
{
  // Member: center_point_x
  cdr >> ros_message.center_point_x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = custom_msg::msg::BoundingBox;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const custom_msg::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<custom_msg::msg::BoundingBox *>(
    untyped_ros_message);
...
{
  return &custom_msg::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, custom_msg, msg, BoundingBox)() {
  return &custom_msg::msg::typesupport_fastrtps_cpp::_BoundingBox__handle;
}
