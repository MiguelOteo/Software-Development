...
#ifndef IMAGE_TOOLS_SDFR__CV_MAT_SENSOR_MSGS_IMAGE_TYPE_ADAPTER_HPP_
#define IMAGE_TOOLS_SDFR__CV_MAT_SENSOR_MSGS_IMAGE_TYPE_ADAPTER_HPP_
...
template<>
struct rclcpp::TypeAdapter<image_tools_sdfr::ROSCvMatContainer, sensor_msgs::msg::Image>
{
  using is_specialized = std::true_type;
  using custom_type = image_tools_sdfr::ROSCvMatContainer;
  ...
  {
    destination = image_tools_sdfr::ROSCvMatContainer(source);
  }
};

#endif  // IMAGE_TOOLS_SDFR__CV_MAT_SENSOR_MSGS_IMAGE_TYPE_ADAPTER_HPP_
