^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
Changelog for package image_tools_sdfr
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^

0.21.0 (2023-12-18)
-------------------
* Renamed from 'image_tools' to 'image_tools_sdfr'
* Burger mode has been replaced by a remote mode that connects to a remote webcam through UDP
